...
android_directories = {
    "9.03": "/PS4_stage_bin_all/PS4-9.03/",
    "9.04": "/PS4_stage_bin_all/PS4-9.04/",
    "9.50": "/PS4_stage_bin_all/PS4-9.50/",
    "9.51": "/PS4_stage_bin_all/PS4-9.51/",
    "9.60": "/PS4_stage_bin_all/PS4-9.60/",
    "10.00": "/PS4_stage_bin_all/PS4-9.61/",
    "10.01": "/PS4_stage_bin_all/PS4-10.01/",
    "10.50": "/PS4_stage_bin_all/PS4-10.50/",
    "10.70": "/PS4_stage_bin_all/PS4-10.70/",
    "10.71": "/PS4_stage_bin_all/PS4-10.71/",
    "11.00": "/PS4_stage_bin_all/PS4-11.00/"
}
...
if platform.system() == "Android":
    directorio_seleccionado = os.path.join(current_directory, directories[version_seleccionada])
else:
...
elif sistema_operativo == "Windows" or sistema_operativo == "Linux":
    comando = f"python pppwn.py --interface=\"{selected_interface}\" --fw={version_seleccionada.replace('.', '')}"
else:
    print(f"El sistema operativo {sistema_operativo} no está soportado.")
    exit(1)
